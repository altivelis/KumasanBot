...
| `/admin addexclude <カテゴリID>` | ポイントカウントしないVCカテゴリを登録 |
...
| `/admin addexclude <カテゴリID>` | 除外カテゴリを追加 |
| `/admin removeexclude <カテゴリID>` | 除外カテゴリを解除 |
| `/admin listexclude` | 除外カテゴリ一覧を表示 |
| `/admin give @ユーザー <金額>` | Pを付与 |
| `/admin take @ユーザー <金額>` | Pを徴収 |
| `/admin addshopitem <名前> <価格> <ロールID>` | ショップ商品を追加 |
